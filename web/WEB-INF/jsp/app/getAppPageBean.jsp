...
<div align="center" style="width: 100%;height: 100%;" >
    ...
    <table id="app_list_datagrid" class="easyui-datagrid" title="应用列表" style="width: 100%;height: auto"
            data-options="
            fitColumns:true,
            autoRowHeight:true,
            rownumbers:true,
    ...
    >
        ...
        <tr>
            ...
            <th data-options="field:'appico',width:50,align:'center'">应用</th>
            <th data-options="field:'appname',width:120,halign:'center'">中文名称</th>



            <th data-options="field:'apptype',width:60,align:'center'">分类</th>

            <th data-options="field:'pagename',width:160,align:'center'">包名</th>
            <th data-options="field:'status',width:60,align:'center'">状态</th>
            <th data-options="field:'appver',width:60,halign:'center'">版本号</th>

            <%--<th data-options="field:'appid9',width:80">app_size</th>--%>
            <th data-options="field:'lastupdate',width:120,align:'center'">最近更新</th>
           ...
           <tr>
            ...
            <td>${app.pack_name}</td>
               ...
               <s:elseif test="#app.status==1">
                   <td><img src="<c:url value="/images/yes.gif"/>" ><a href="/appAction_appOfflineToggle?id=${app.app_id}" >上架</a></td>
               </s:elseif>
               <s:elseif test="#app.status==2">
                   <td><img src="<c:url value="/images/no.gif"/>"><a href="/appAction_appOfflineToggle?id=${app.app_id}" >下架</a></td>
               </s:elseif>
            ...
            <%--<td><a href="/appAction_updateAppById?id=${app.app_id}">
               ...
               <td>
                   <%--<a href="javascript:void(0)" onclick="javascript:updateIt('${app.app_id}','${app.app_name}')">
                   <img src="<c:url value="/images/icon_edit.gif"/>" alt="编辑" width="20px" height="20px"></a>--%>
                       <a href="/appAction_editApp?id=${app.app_id}" >
                           <img src="<c:url value="/images/icon_edit.gif"/>" alt="编辑" width="20px" height="20px"></a>
